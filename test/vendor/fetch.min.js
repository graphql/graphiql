!(function() {
  ...
  function t(t) {
    if (
      ('string' != typeof t &&
        (t = t.toString()), /[^a-z0-9\-#$%&'*+.\^_`|~]/i.test(t))
    )
  ...
  function f(t, e) {
    if (
      ((e = e || {}), (this.url = t), (this.credentials = e.credentials ||
        'omit'), (this.headers = new r(e.headers)), (this.method = u(
        e.method || 'GET',
      )), (this.mode = e.mode || null), (this.referrer = null), ('GET' ===
        this.method ||
        'HEAD' === this.method) &&
        e.body)
    )
  ...
  function l(t, e) {
    e || (e = {}), this._initBody(
      t,
    ), (this.type = 'default'), (this.url = null), (this.status = e.status), (this.ok = this.status >=
      200 &&
      this.status <
        300), (this.statusText = e.statusText), (this.headers = e.headers instanceof
      r
      ? e.headers
