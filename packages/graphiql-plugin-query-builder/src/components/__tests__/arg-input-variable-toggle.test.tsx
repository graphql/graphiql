...
describe('ArgInput — variable toggle', () => {
  ...
  it('shows "Inline argument" on the toggle when isVariable is true', () => {
    render(
      <ArgInput
        arg={makeArg('first', GraphQLInt)}
        value=""
  ...
  it('has aria-pressed=true on the toggle when isVariable is true', () => {
    ...
    const btn = screen.getByRole('button', { name: /inline argument/i });
  ...
  it('calls onDemote with (argName, varName) when active toggle is clicked', async () => {
