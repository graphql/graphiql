...
Check out [graphql-config](https://the-guild.dev/graphql/config/docs) to learn the many ways you can define your graphql config
...
use graphql config [`loadConfig`](https://the-guild.dev/graphql/config/docs/library/load-config) for further customization:
