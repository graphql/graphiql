...
import _GraphQLLogoIcon from './graphql-logo.svg?react';
...
import _QueryBuilderIcon from './query-builder.svg?react';
import _ReloadIcon from './reload.svg?react';
import _RootTypeIcon from './root-type.svg?react';
import _SaveIcon from './save.svg?react';
...
export const GraphQLLogoIcon = generateIcon(_GraphQLLogoIcon);
...
export const QueryBuilderIcon = generateIcon(_QueryBuilderIcon);
export const ReloadIcon = generateIcon(_ReloadIcon);
export const RootTypeIcon = generateIcon(_RootTypeIcon);
export const SaveIcon = generateIcon(_SaveIcon);
