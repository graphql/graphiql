...
export class CompletionAdapter implements monaco.languages.CompletionItemProvider {
    ...
    async provideCompletionItems(model: monaco.editor.IReadOnlyModel, position: Position, _context: monaco.languages.CompletionContext, _token: CancellationToken): Promise<monaco.languages.CompletionList> {
...
export class HoverAdapter implements monaco.languages.HoverProvider {
    ...
    async provideHover(model: monaco.editor.IReadOnlyModel, position: Position, _token: CancellationToken): Promise<monaco.languages.Hover | undefined> {
        const resource = model.uri;
        const worker = await this._worker(resource)
...
export class DocumentSymbolAdapter implements monaco.languages.DocumentSymbolProvider {
    ...
    public provideDocumentSymbols(model: monaco.editor.IReadOnlyModel, _token: CancellationToken): Thenable<monaco.languages.DocumentSymbol[]> {
        const resource = model.uri;
