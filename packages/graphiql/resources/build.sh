...
browserify -g browserify-shim -r regenerator-runtime/runtime -s GraphiQL cdn/index.js > graphiql.js

echo "Bundling graphiql.min.js..."
browserify -g browserify-shim \
-r regenerator-runtime/runtime -t uglifyify -s GraphiQL \
cdn/index.js 2> /dev/null | uglifyjs -c > graphiql.min.js 2> /dev/null
