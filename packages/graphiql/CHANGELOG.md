...
- [#2523](https://github.com/graphql/graphiql/pull/2523) [`fdcd9054`](https://github.com/graphql/graphiql/commit/fdcd9054483404bcae4a464ac7212e0d35f49abd) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: The `GraphiQL` component does no longer set a property `g` on the `window` object.

* [#2523](https://github.com/graphql/graphiql/pull/2523) [`d1805200`](https://github.com/graphql/graphiql/commit/d1805200bba2a4237e40d27986ea0ba5adc33139) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: Implement a new design for the GraphiQL UI. This changes both DOM structure and class names. We consider this a breaking change as custom GraphQL IDEs built on top of GraphiQL relied on these internals, e.g. overriding styles using certain class names.

- [#2523](https://github.com/graphql/graphiql/pull/2523) [`9fc6b476`](https://github.com/graphql/graphiql/commit/9fc6b4765aa848671a3046a728665de6fab768cb) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: The following static properties of the `GraphiQL` component have been removed:
...
* [#2523](https://github.com/graphql/graphiql/pull/2523) [`864dfb03`](https://github.com/graphql/graphiql/commit/864dfb0338116e2aa3c387deeb35c29b0869e0b3) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: The following exports of the `graphiql` package have been removed:
...
- [#2523](https://github.com/graphql/graphiql/pull/2523) [`2c860e10`](https://github.com/graphql/graphiql/commit/2c860e10e72d4a969a4cb1910c10c3a38e6f8fcb) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: The `GraphiQL` component has been refactored to be a function component. Attaching a ref to this component will no longer provide access to props, state or class methods. In order to interact with or change `GraphiQL` state you need to use the contexts and hooks provided by the `@graphiql/react` package. More details and examples can be found in the migration guide.

* [#2523](https://github.com/graphql/graphiql/pull/2523) [`11c2778b`](https://github.com/graphql/graphiql/commit/11c2778b0d50b2380a9cd12bdaaa396ceee8f62a) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - BREAKING: The following props of the `GraphiQL` component have been changed:
...
- [#2523](https://github.com/graphql/graphiql/pull/2523) [`4f714053`](https://github.com/graphql/graphiql/commit/4f714053a2ed2509e7c6a91f39f1b427da1925b5) Thanks [@thomasheyenbrock](https://github.com/thomasheyenbrock)! - GraphiQL now ships with a dark theme. By default the interface respects the system settings, the theme can also be explicitly chosen via the new settings dialog.

### Patch Changes

- Updated dependencies [[`e1c6e3bf`](https://github.com/graphql/graphiql/commit/e1c6e3bf1d0590a3564fab431f054468aa6141ff), [`d1805200`](https://github.com/graphql/graphiql/commit/d1805200bba2a4237e40d27986ea0ba5adc33139), [`b5a7bee1`](https://github.com/graphql/graphiql/commit/b5a7bee1c162771854c9bd4ba7e4c0a29a31b98a), [`11c2778b`](https://github.com/graphql/graphiql/commit/11c2778b0d50b2380a9cd12bdaaa396ceee8f62a), [`01cd313b`](https://github.com/graphql/graphiql/commit/01cd313bcb4f3d0c1b9f7539917225803f2109e3), [`41236709`](https://github.com/graphql/graphiql/commit/41236709749829ac69ffdc8cd81eb7a96e1695c6)]:
