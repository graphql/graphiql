...
- `autoPrettify`: an optional boolean that when set to `true` automatically pretty prints the GraphQL query as soon as the component mounts. This does the same thing as manually clicking the `Prettify` button after the component has mounted.
